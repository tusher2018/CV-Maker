      ...
      Column(
        ...
        children: [
          commonText(capitalizeFirstLetterOfEachWord(widget.name),
              isBold: true, color: Colors.black, size: fontSize + 12),
                ...
                child: Screenshot(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      if (widget.isTemplet2)
                        Positioned(
                          top: -8,
                          right: -5,
                          child: Image.asset(
                            "assets/imges/temp2_bg.png",
                            width: 180,
                            color: Colors.black,
                          ),
                        ),
