...
class CvTemplate7 extends StatefulWidget {
  ...
  @override
  State<CvTemplate7> createState() => _CvTemplate7State();
}

class _CvTemplate7State extends State<CvTemplate7> {
  double fontSize = 12.0;
  double rightSideSpace = 10.0;
  ...
  bool titleOutline = false, titleTrail = false;
              ...
              Column(
                ...
                children: [
                  commonText(capitalizeFirstLetterOfEachWord(widget.name),
                      isBold: true, color: Colors.black, size: fontSize + 21),
                  commonText(capitalizeFirstLetterOfEachWord(widget.profession),
                      color: Colors.black, size: fontSize + 12),
                ],
              ),
              Visibility(
                ...
                child: Container(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        border: Border.all(
                            width: 5, color: Color.fromRGBO(21, 84, 128, 1)),
                      ...
                      children: [
                        Visibility(
                            ...
                            child: commonText('Phone: ',
                                color: Colors.black, size: fontSize + 2)),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Visibility(
                          ...
                          children: [
                            ...
                            Expanded(
                                child: commonText(widget.email,
                                    size: fontSize, color: Colors.black87)),
                          ],
                        ),
                      ],
                    ),
            ...
            Column(
              children: [
                ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: widget.experence.length,
                      ...
                      Row(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: experienceItem(widget.experence[index]),
                            )),
                          ]),
                      SizedBox(
                        height: rightSideSpace * 0.2,
                      ...
                      Row(
                          ...
                          children: [
                            Expanded(
                              ...
                              padding:
                                  const EdgeInsets.only(left: 8.0, right: 8.0),
                              child: educationItem(widget.education[index]),
                            )),
                          ]),
                      SizedBox(
                        height: rightSideSpace * 0.2,
                      ...
                      ? Column(
                          ...
                          (index) {
                            return Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                commonText(widget.skills[index],
                                    color: Colors.white),
                                FittedBox(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  border: Border.all(
                    ...
                    color:
                        (titleOutline) ? backgroundColor : Colors.transparent,
                  ),
  ...
  Widget experienceItem(Experience experence) {
    return Row(
      ...
      children: [
        Expanded(
          child: (experence.year != null && experence.year!.isNotEmpty)
              ? commonText(experence.year!,
        ...
        Expanded(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              if (experence.companyName != null &&
                  experence.companyName!.isNotEmpty)
              ...
              if (experence.description != null &&
                  experence.description!.isNotEmpty)
  ...
  Widget educationItem(Education education) {
    return Row(
      ...
      children: [
        Expanded(
          child: (education.year != null && education.year!.isNotEmpty)
              ? commonText(education.year!,
                  color: Colors.black87, size: fontSize)
              : SizedBox(),
        ),
        Expanded(
